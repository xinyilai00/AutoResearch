...
def fallback_analysis_spec(dataset_report: dict, schema_report: dict, reason: str) -> dict:
    ...
    return {
        ...
        "task_type": "auto" if all_csv else "inspect",
        "dataset_url": urls[0],
        "dataset_urls": urls,
        "dataset_name": "dataset_agent_candidates",
        "target_column": first_target_candidate(schema_report) if all_csv else "TO_VERIFY",
        "feature_columns": ["AUTO_NUMERIC"],
        "baseline": "majority_class for classification or mean_prediction for regression",
        "success_metric": "accuracy" if all_csv else "inspect",
        "success_threshold": 0.0,
