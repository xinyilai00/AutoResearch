...
def run_pi_agent_test(user_topic):
    """
    Standalone version of run_pi_agent with no pipeline state dependency.
    Safe to call without any experiment anchor being set.
    """
    headers = {
...
if __name__ == "__main__":
    ...
    print(run_pi_agent_test(user_topic))